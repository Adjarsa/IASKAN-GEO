...
class TestIdentifyCompetitorsFunction:
    ...
    def test_responses_containing_count(self):
        ...
        responses = [
            {"response_excerpt": "Semrush is the best SEO tool.", "ai_type": "chatgpt"},
            {"response_excerpt": "I recommend Semrush for keyword research.", "ai_type": "claude"},
            {"response_excerpt": "Ahrefs is also popular.", "ai_type": "gemini"}
        ]
    ...
    def test_ai_sources_tracking(self):
        ...
        responses = [
            {"response_excerpt": "Semrush is excellent.", "ai_type": "chatgpt"},
            {"response_excerpt": "Semrush offers great features.", "ai_type": "claude"},
            {"response_excerpt": "Semrush is recommended.", "ai_type": "gemini"}
        ]
