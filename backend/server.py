...
async def send_verification_email(email: str, user_name: str, token: str) -> bool:
    ...
    frontend_url = os.environ.get('FRONTEND_URL', 'https://content-citability.preview.emergentagent.com')
...
async def create_oauth_user_session(email: str, name: str, picture: str, provider: str, response: Response):
    ...
    if is_new_user and RESEND_API_KEY:
        frontend_url = "https://content-citability.preview.emergentagent.com"
