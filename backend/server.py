...
SUBSCRIPTION_PLANS = {
    ...
    "pro": {
        "name": "Pro",
        "price": 149.00,
        "queries_limit": 80000,  # 100 prompts × 4 runs × 4 IA × 50 scans = 80000
        "scans_limit": 50,
        "projects_limit": 5,
        "num_prompts": 100,
        "runs_per_query": 4,
        "ai_engines": ["chatgpt", "claude", "gemini", "perplexity"],
        "features": ["50 scans/mois", "100 prompts/scan", "4 runs/requête", "1 600 requêtes/scan", "80 000 requêtes/mois", "4 IA (ChatGPT, Claude, Gemini, Perplexity)", "Benchmark concurrents", "Analyse de stabilité avancée", "5 projets", "Support prioritaire"]
    },
    "business": {
        "name": "Business",
        "price": 349.00,
        "queries_limit": 600000,  # 200 prompts × 5 runs × 4 IA × 150 scans = 600000
        "scans_limit": 150,
        "projects_limit": -1,  # illimité
        "num_prompts": 200,
        "runs_per_query": 5,
        "ai_engines": ["chatgpt", "claude", "gemini", "perplexity"],
        "features": ["150 scans/mois", "200 prompts/scan", "5 runs/requête", "4 000 requêtes/scan", "600 000 requêtes/mois", "4 IA (ChatGPT, Claude, Gemini, Perplexity)", "Génération d'articles GEO", "Intelligence stratégique", "Projets illimités", "API access", "Support dédié"]
    }
}
