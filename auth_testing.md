...
```bash
# Test auth endpoint
curl -X GET "https://visibility-ai-5.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test projects endpoint
curl -X GET "https://visibility-ai-5.preview.emergentagent.com/api/projects" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test subscription plans
curl -X GET "https://visibility-ai-5.preview.emergentagent.com/api/subscription/plans"

# Test dashboard stats
curl -X GET "https://visibility-ai-5.preview.emergentagent.com/api/dashboard/stats" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.goto("https://visibility-ai-5.preview.emergentagent.com/dashboard");
```
